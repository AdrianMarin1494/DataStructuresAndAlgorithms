...
var minWindow = function(s, t) {
    ...
    let left = 0, right = 0, minLength = Infinity, minLeft = 0, requiredChars = targetFreq.size;
    ...
    while (right < s.length) {
        ...
        if (targetFreq.has(currentChar) && windowFreq.get(currentChar) === targetFreq.get(currentChar)) {
            requiredChars--;
        }
